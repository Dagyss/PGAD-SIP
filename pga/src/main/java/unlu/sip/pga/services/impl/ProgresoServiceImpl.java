...
public class ProgresoServiceImpl implements ProgresoService {
    ...
    public List<Progreso> listarProgresosPorUsuarioCurso(Integer idUsuario, Integer cursoId) { return progresoRepository.findByUsuario_IdUsuarioAndCurso_IdCurso(idUsuario, cursoId); }
